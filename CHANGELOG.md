...
## [1.4.0](https://github.com/weihanglo/cc-rs/compare/cc-v1.3.0...cc-v1.4.0) - 2026-09-11

### Added

- inherit path remap rules from cargo trim-paths ([#1794](https://github.com/weihanglo/cc-rs/pull/1794))
...
- *(ar)* suppress warnings from `D` modifier probe ([#1700](https://github.com/weihanglo/cc-rs/pull/1700))
- *(ar)* deterministic archives with `D` modifier ([#1697](https://github.com/weihanglo/cc-rs/pull/1697))
...
- *(cc)* release v1.3.0 ([#1796](https://github.com/weihanglo/cc-rs/pull/1796))
- *(cc)* release v1.2.67 ([#1789](https://github.com/weihanglo/cc-rs/pull/1789))
- Bump taiki-e/install-action from 2.81.8 to 2.82.8 ([#1786](https://github.com/weihanglo/cc-rs/pull/1786))
- Fix clippy warning ([#1788](https://github.com/weihanglo/cc-rs/pull/1788))
- Regenerate target info ([#1785](https://github.com/weihanglo/cc-rs/pull/1785))
- Add missing todo for deprecated API
- Add support for `aarch64-unknown-linux-pauthtest` target ([#1713](https://github.com/weihanglo/cc-rs/pull/1713))
- Fix nightly compilation error ([#1783](https://github.com/weihanglo/cc-rs/pull/1783))
- *(cc)* release v1.2.66 ([#1777](https://github.com/weihanglo/cc-rs/pull/1777))
- Fix target parsing ([#1779](https://github.com/weihanglo/cc-rs/pull/1779))
- *(test-wasm)* do not download pre release of wasi-sdk ([#1778](https://github.com/weihanglo/cc-rs/pull/1778))
- Support new QNX targets ([#1775](https://github.com/weihanglo/cc-rs/pull/1775))
- Add kache to the supported compiler wrappers ([#1770](https://github.com/weihanglo/cc-rs/pull/1770))
- Bump actions/checkout from 6.0.3 to 7.0.0 ([#1767](https://github.com/weihanglo/cc-rs/pull/1767))
- *(cc)* release v1.2.65 ([#1764](https://github.com/weihanglo/cc-rs/pull/1764))
- Regenerate target info ([#1763](https://github.com/weihanglo/cc-rs/pull/1763))
- Bump taiki-e/install-action from 2.77.6 to 2.81.8 ([#1758](https://github.com/weihanglo/cc-rs/pull/1758))
- Bump release-plz/action from 0.5.129 to 0.5.130 ([#1759](https://github.com/weihanglo/cc-rs/pull/1759))
- *(cc)* release v1.2.64 ([#1757](https://github.com/weihanglo/cc-rs/pull/1757))
- Add more bare-metal 32-bit Arm support ([#1753](https://github.com/weihanglo/cc-rs/pull/1753))
- Bump actions/checkout from 6.0.2 to 6.0.3 ([#1751](https://github.com/weihanglo/cc-rs/pull/1751))
- Remove unnecessary clone ([#1748](https://github.com/weihanglo/cc-rs/pull/1748))
- Update rusqlite requirement from 0.39.0 to 0.40.0 ([#1744](https://github.com/weihanglo/cc-rs/pull/1744))
- Add default compiler prefixes for thumbv7a/thumbv7r/thumbv8r bare-metal targets ([#1742](https://github.com/weihanglo/cc-rs/pull/1742))
- *(cc)* release v1.2.63 ([#1740](https://github.com/weihanglo/cc-rs/pull/1740))
- Update shlex requirement from 1.3.0 to 2.0.1 ([#1736](https://github.com/weihanglo/cc-rs/pull/1736))
- Bump release-plz/action from 0.5.128 to 0.5.129 ([#1728](https://github.com/weihanglo/cc-rs/pull/1728))
- Bump taiki-e/install-action from 2.75.28 to 2.77.6 ([#1729](https://github.com/weihanglo/cc-rs/pull/1729))
- Bump taiki-e/install-action from 2.75.19 to 2.75.28 ([#1722](https://github.com/weihanglo/cc-rs/pull/1722))
- *(cc)* release v1.2.62 ([#1716](https://github.com/weihanglo/cc-rs/pull/1716))
- Regenerate target info ([#1721](https://github.com/weihanglo/cc-rs/pull/1721))
- Allow exceptions on wasm platforms ([#1714](https://github.com/weihanglo/cc-rs/pull/1714))
- Add relibc env ([#1710](https://github.com/weihanglo/cc-rs/pull/1710))
- recognize sh4 architecture in parse_arch() ([#1712](https://github.com/weihanglo/cc-rs/pull/1712))
- Bump taiki-e/install-action from 2.75.18 to 2.75.19 ([#1709](https://github.com/weihanglo/cc-rs/pull/1709))
- Bump taiki-e/install-action from 2.75.17 to 2.75.18 ([#1708](https://github.com/weihanglo/cc-rs/pull/1708))
- *(cc)* release v1.2.61 ([#1707](https://github.com/weihanglo/cc-rs/pull/1707))
- Bump taiki-e/install-action from 2.75.16 to 2.75.17 ([#1706](https://github.com/weihanglo/cc-rs/pull/1706))
- fix `OutputKind::Capture` documentation ([#1705](https://github.com/weihanglo/cc-rs/pull/1705))
- Bump taiki-e/install-action from 2.75.4 to 2.75.5 ([#1703](https://github.com/weihanglo/cc-rs/pull/1703))
- Hash-pin all actions, apply other suggestions from zizmor ([#1702](https://github.com/weihanglo/cc-rs/pull/1702))
- *(cc)* release v1.2.60 ([#1701](https://github.com/weihanglo/cc-rs/pull/1701))
- *(cc)* release v1.2.59 ([#1699](https://github.com/weihanglo/cc-rs/pull/1699))
- Regenerate target info ([#1698](https://github.com/weihanglo/cc-rs/pull/1698))
